...
call s:hi('Type',           s:brt,  s:nil,  s:norm)
...
call s:hi('ALEWarning',     s:bg,   s:fnt,  s:norm)
...
call s:hi('ALEError',       s:bg,   s:drk,  s:norm)
...
call s:hi('WildMenu',       s:fnt,  s:nil)
...
call s:hi('StatusLineNC',   s:bg,   s:fnt,  s:norm)
