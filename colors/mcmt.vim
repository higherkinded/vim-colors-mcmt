...
call s:hi('ALEWarning',           s:fg,   s:nil,  s:undr)
call s:hi('ALEWarningSign',       s:bg,   s:fnt)
call s:hi('ALEWarningSignLineNr', s:bg,   s:fnt,  s:norm)
call s:hi('ErrorMsg',             s:drk,  s:bg,   s:norm)
call s:hi('Error',                s:drk,  s:bg,   s:undr)
call s:hi('SpellBad',             s:bg,   s:drk,  s:norm)
call s:hi('ALEError',             s:drk,  s:nil,  s:undr)
call s:hi('ALEErrorSign',         s:drk,  s:nil)
call s:hi('ALEErrorSignLineNr',   s:drk,  s:nil,  s:norm)
...
call s:hi('StatusLineTerm',       s:bg,   s:drk,  s:norm)
call s:hi('StatusLineNC',         s:bfg,  s:mfnt, s:norm)
call s:hi('StatusLineTermNC',     s:bfg,  s:mfnt, s:norm)
